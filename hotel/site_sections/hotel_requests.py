...
class Root:
    ...
    def index(self, session, message='', decline=None, **params):
        ...
        nights = []
        three_day_before = (c.EPOCH - timedelta(days=3)).strftime('%A')
        ...
        nights.append([getattr(c, three_day_before.upper()), getattr(requests, three_day_before.upper()),
                       "I'd like to help set up on " + three_day_before])
