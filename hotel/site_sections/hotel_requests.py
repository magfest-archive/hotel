...
class Root:
    ...
    def index(self, session, message='', decline=None, **params):
        ...
        nights = []
        2day_before = (c.EPOCH - timedelta(days=2)).strftime('%A')
        ...
        nights.append([getattr(c, 2day_before.upper()), getattr(requests, 2day_before.upper()),
                       "I'd like to help set up on " + 2day_before])
